...
import { useUserInfoContext } from "../userInfo/UserHooks";
...
const PostStatus: React.FC<PostStatusProps> = ({ postPresenter }) =>{
  ...
  if (!presenterRef.current) {
    presenterRef.current = postPresenter ?? new PostPresenter(view);
  }
